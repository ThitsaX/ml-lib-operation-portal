...
public class ModifyRevenueApprovalActionController {

    private static final Logger LOG = LoggerFactory.getLogger(ModifyRevenueApprovalActionController.class);

    private final ModifyRevenueApprovalAction modifyRevenueApprovalAction;

    private final ObjectMapper objectMapper;

    @PostMapping(value = "/secured/modifyRevenueApprovalAction")
    public ResponseEntity<Response> execute(@Valid @RequestBody Request request)
        throws JsonProcessingException, DomainException {

        LOG.info("Modify Revenue Approval Request : [{}]", this.objectMapper.writeValueAsString(request));
        ...
        LOG.info("Modify Revenue Approval Response : [{}]", this.objectMapper.writeValueAsString(response));
