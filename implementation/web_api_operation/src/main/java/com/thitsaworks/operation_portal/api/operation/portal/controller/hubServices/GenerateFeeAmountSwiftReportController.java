...
public class GenerateFeeAmountSwiftReportController {

    private static final Logger LOG = LoggerFactory.getLogger(
        GenerateFeeAmountSwiftReportController.class);

    private final GenerateFeeAmountSwiftReport GenerateFeeAmountSwiftReport;

    @PostMapping("/secured/generateFeeAmountReport")
    public ResponseEntity<Response> execute(@RequestParam("settlementId") String settlementId,
        ...
        LOG.info(
            "Generate Fee Amount Report : settlementId = [{}], currencyId = [{}], timezoneOffset = [{}]",
        ...
        GenerateFeeAmountSwiftReport.Output output = this.GenerateFeeAmountSwiftReport.execute(
            new GenerateFeeAmountSwiftReport.Input(
                settlementId, currencyId, timezone,
                userContext.userId().getId()));

        var response = new Response(output.reportData());

        LOG.info("Generate Fee Amount Report Response : [{}]", response);
