...
public class GetRevenuePartyByIdController {

    private static final Logger LOG = LoggerFactory.getLogger(GetRevenuePartyByIdController.class);

    private final GetRevenuePartyById getRevenuePartyById;
