...
public class GetPendingRevenueApprovalListController {

    private static final Logger LOG = LoggerFactory.getLogger(
        GetPendingRevenueApprovalListController.class);

    private final GetPendingRevenueApprovalList getPendingRevenueApprovalList;

    private final ObjectMapper objectMapper;

    @GetMapping(value = "/secured/getPendingRevenueApprovalList")
    public ResponseEntity<Response> execute() throws DomainException, JsonProcessingException {

        var output = this.getPendingRevenueApprovalList.execute(
            new GetPendingRevenueApprovalList.Input());
        ...
        LOG.info(
            "Get Pending Revenue Approval List Response : [{}]",
