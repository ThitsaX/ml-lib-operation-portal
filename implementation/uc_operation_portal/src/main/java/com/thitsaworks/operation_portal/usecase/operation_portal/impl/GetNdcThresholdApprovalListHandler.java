...
public class GetNdcThresholdApprovalListHandler
    extends OperationPortalUseCase<GetNdcThresholdApprovalList.Input,
                                    GetNdcThresholdApprovalList.Output>
    implements GetNdcThresholdApprovalList {

    private final NdcThresholdApprovalService approvalService;

    public GetNdcThresholdApprovalListHandler(
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        return new Output(this.approvalService.getApprovals(input.status()));
    }
}
