...
public interface GetNdcAlertEventList
    extends UseCase<GetNdcAlertEventList.Input, GetNdcAlertEventList.Output> {
    ...
    record Output(List<NdcAlertEventData> alerts) {
    }
}
