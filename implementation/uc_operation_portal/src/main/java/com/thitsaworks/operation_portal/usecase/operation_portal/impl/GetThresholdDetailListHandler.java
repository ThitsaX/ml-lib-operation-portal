...
public class GetThresholdDetailListHandler
    extends OperationPortalAuditableUseCase<GetThresholdDetailList.Input,
        GetThresholdDetailList.Output>
    implements GetThresholdDetailList {

    private final ThresholdDetailQuery thresholdDetailQuery;

    public GetThresholdDetailListHandler(CreateInputAuditCommand createInputAuditCommand,
