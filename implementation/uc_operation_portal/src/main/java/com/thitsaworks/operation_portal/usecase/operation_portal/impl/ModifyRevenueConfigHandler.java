...
public class ModifyRevenueConfigHandler
    extends OperationPortalAuditableUseCase<ModifyRevenueConfig.Input, ModifyRevenueConfig.Output>
    implements ModifyRevenueConfig {

    private final ModifyRevenueConfigCommand modifyRevenueConfigCommand;

    private final UserPermissionManager userPermissionManager;

    public ModifyRevenueConfigHandler(CreateInputAuditCommand createInputAuditCommand,
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        var output = this.modifyRevenueConfigCommand.execute(new ModifyRevenueConfigCommand.Input(
