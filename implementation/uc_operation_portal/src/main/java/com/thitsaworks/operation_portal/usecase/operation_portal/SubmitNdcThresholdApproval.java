...
public interface SubmitNdcThresholdApproval
    extends UseCase<SubmitNdcThresholdApproval.Input, SubmitNdcThresholdApproval.Output> {

    record Input(NdcThresholdApprovalOperation operation,
