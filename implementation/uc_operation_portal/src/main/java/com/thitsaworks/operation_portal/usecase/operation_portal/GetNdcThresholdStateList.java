...
public interface GetNdcThresholdStateList
    extends UseCase<GetNdcThresholdStateList.Input, GetNdcThresholdStateList.Output> {
    ...
    record Output(List<NdcThresholdStateData> states) {
    }
}
