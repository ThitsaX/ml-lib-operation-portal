...
public class GenerateRevenueSharingDetailReportHandler
    extends OperationPortalAuditableUseCase<GenerateRevenueSharingDetailReport.Input, GenerateRevenueSharingDetailReport.Output>
    implements GenerateRevenueSharingDetailReport {

    private static final Logger LOG = LoggerFactory.getLogger(
        GenerateRevenueSharingDetailReportHandler.class);
    ...
    public GenerateRevenueSharingDetailReportHandler(CreateInputAuditCommand createInputAuditCommand,
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        params.put("taxCode", this.normalizeFilter(input.taxCode()));
        params.put("category", this.normalizeFilter(input.category()));

        ReportDownloadRequestManager.CreateOrReuseResult result = this.reportDownloadRequestManager.createPendingOrReuse(
            ReportType.REVENUE_SHARING_DETAIL, normalizedFileType, params);
        ...
        if (FileDownloadStatus.FAILED.equals(result.request().status())) {
            throw new ReportException(
                ReportDownloadUtil.resolveFailedError(
                    ...
                    ReportErrors.REVENUE_SHARING_DETAIL_REPORT_FAILURE_EXCEPTION));
        }
