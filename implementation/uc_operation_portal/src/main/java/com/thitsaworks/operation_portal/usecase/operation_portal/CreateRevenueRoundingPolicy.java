...
public interface CreateRevenueRoundingPolicy
    extends UseCase<CreateRevenueRoundingPolicy.Input, CreateRevenueRoundingPolicy.Output> {

    record Input(RevenueRoundingMode roundingMode,
                 RevenueRemainderRecipient remainderRecipient) { }

    record Output(boolean created,
                  RevenueRoundingPolicyId revenueRoundingPolicyId) { }
}
