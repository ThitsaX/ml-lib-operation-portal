...
public class GetNdcJobExecutionLogListHandler
    extends OperationPortalUseCase<GetNdcJobExecutionLogList.Input, GetNdcJobExecutionLogList.Output>
    implements GetNdcJobExecutionLogList {

    private final JobExecutionLogQuery jobExecutionLogQuery;

    public GetNdcJobExecutionLogListHandler(PrincipalCache principalCache,
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        return new Output(this.jobExecutionLogQuery.searchJobExecutionLogs(
            GetNdcThresholdStateListHandler.blankToNull(input.jobName()),
            input.jobStatus(),
