...
public interface SubmitParticipantBalance
    extends UseCase<SubmitParticipantBalance.Input, SubmitParticipantBalance.Output> {

    record Input(String participantId,
                 PositionActionType action,
                 BigDecimal amount,
                 Currency currency,
                 ExtensionList extensionList,
                 UserId requestedBy) implements Serializable { }

    record Output(String status) implements Serializable { }
