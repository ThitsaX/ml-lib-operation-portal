...
public interface ModifyRevenueParty extends UseCase<ModifyRevenueParty.Input, ModifyRevenueParty.Output> {
    ...
    record Output(boolean modified,
                  ...
                  RevenuePartyData beforeValue,
                  RevenuePartyData afterValue) { }
