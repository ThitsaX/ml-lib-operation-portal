...
public class GetNdcDeliveryLogListHandler
    extends OperationPortalUseCase<GetNdcDeliveryLogList.Input, GetNdcDeliveryLogList.Output>
    implements GetNdcDeliveryLogList {

    private final NdcRuntimeQuery ndcRuntimeQuery;

    public GetNdcDeliveryLogListHandler(PrincipalCache principalCache,
