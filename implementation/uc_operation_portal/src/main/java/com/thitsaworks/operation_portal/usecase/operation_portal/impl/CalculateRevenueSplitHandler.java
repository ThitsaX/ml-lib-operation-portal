...
public class CalculateRevenueSplitHandler
    extends OperationPortalUseCase<CalculateRevenueSplit.Input, CalculateRevenueSplit.Output>
    implements CalculateRevenueSplit {

    private final RevenueEngine revenueEngine;

    public CalculateRevenueSplitHandler(
    ...
    protected Output onExecute(Input input) throws DomainException {
        ...
        return new Output(this.revenueEngine.calculateRevenue(input.taxCodeId(), input.amount()));
    }
}
