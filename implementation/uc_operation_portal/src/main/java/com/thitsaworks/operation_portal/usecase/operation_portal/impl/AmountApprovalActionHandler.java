...
public class AmountApprovalActionHandler {

    private static final Logger LOG = LoggerFactory.getLogger(AmountApprovalActionHandler.class);
    ...
    public void execute(ModifyApprovalAction.Input input,
