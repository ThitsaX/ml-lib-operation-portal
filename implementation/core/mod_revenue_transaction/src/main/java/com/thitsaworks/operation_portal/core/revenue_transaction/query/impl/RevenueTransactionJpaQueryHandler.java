 ...
 */
package com.thitsaworks.operation_portal.core.revenue_transaction.query.impl;
...
public class RevenueTransactionJpaQueryHandler implements RevenueTransactionQuery {

    private final RevenueTransactionRepository revenueTransactionRepository;

    @Override
    public RevenueTransactionData get(RevenueTransactionId revenueTransactionId)
            throws RevenueTransactionException {

        return this.revenueTransactionRepository.findById(revenueTransactionId)
                                                .map(RevenueTransactionData::new)
                                                .orElseThrow(() -> new RevenueTransactionException(
                                                        RevenueTransactionErrors
                                                                .REVENUE_TRANSACTION_NOT_FOUND
                                                                .format(revenueTransactionId.toString())));
    }
}
