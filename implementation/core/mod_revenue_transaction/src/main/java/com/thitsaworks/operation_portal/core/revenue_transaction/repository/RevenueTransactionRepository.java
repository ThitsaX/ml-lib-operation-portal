...
@Repository
public interface RevenueTransactionRepository extends JpaRepository<RevenueTransaction, RevenueTransactionId> {

    Optional<RevenueTransaction> findByHubTransactionId(String hubTransactionId);
}
