 ...
 */
package com.thitsaworks.operation_portal.core.revenue_transaction.query;
...
public interface RevenueTransactionQuery {

    RevenueTransactionData get(RevenueTransactionId revenueTransactionId)
