 ...
 */
package com.thitsaworks.operation_portal.core.revenue_transaction;
...
@ComponentScan("com.thitsaworks.operation_portal.core.revenue_transaction")
@Import(value = {
        MiscConfiguration.class, CorePersistenceConfiguration.class
})
public class RevenueTransactionConfiguration {
}
