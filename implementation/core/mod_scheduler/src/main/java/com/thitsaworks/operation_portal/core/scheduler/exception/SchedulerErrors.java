...
public class SchedulerErrors {
    ...
    public static final ErrorMessage SCHEDULER_CONFIG_JOB_NAME_NOT_FOUND = new ErrorMessage("SCHEDULER_CONFIG_JOB_NAME_NOT_FOUND", "System cannot find the scheduler config with provided job name : [{0}].");
