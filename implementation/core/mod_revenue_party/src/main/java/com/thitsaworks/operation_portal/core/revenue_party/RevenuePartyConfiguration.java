 ...
 */
package com.thitsaworks.operation_portal.core.revenue_party;
...
@ComponentScan("com.thitsaworks.operation_portal.core.revenue_party")
@Import(value = {
        MiscConfiguration.class, CorePersistenceConfiguration.class
})
public class RevenuePartyConfiguration {
}
