...
public interface ModifyRevenuePartyCommand {
    record Input(RevenuePartyId revenuePartyId, String partyCode, String partyName, String partyType,
                 String description, UserId updatedBy) {}
